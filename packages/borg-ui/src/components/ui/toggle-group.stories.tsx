...
import { AlignCenterHorizontalIcon, AlignLeftIcon, AlignRightIcon } from '@phosphor-icons/react'
...
export const Multiple: Story = {
  render: () => {
    ...
    return (
      <ToggleGroup type='multiple' value={value} onValueChange={setValue} spacing={1}>
