  ...
  render: () => {
    ...
    return (
      <Tabs value={value} onValueChange={setValue} style={{ width: 500 }}>
        ...
        <TabsContent value='overview'>Run status, connection health, and recent completions.</TabsContent>
        <TabsContent value='ports'>3 active ports: `telegram`, `http`, and `cli`.</TabsContent>
        <TabsContent value='history'>No regressions in the last 7 days.</TabsContent>
      </Tabs>
    )
  },
}
