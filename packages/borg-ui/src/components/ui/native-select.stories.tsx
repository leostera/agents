      ...
      <div className='grid gap-2 max-w-xs'>
        ...
        >
          <NativeSelectOptGroup label='OpenAI'>
            <NativeSelectOption value='gpt-4.1-mini'>gpt-4.1-mini</NativeSelectOption>
            <NativeSelectOption value='gpt-4.1'>gpt-4.1</NativeSelectOption>
          </NativeSelectOptGroup>
          <NativeSelectOptGroup label='Anthropic'>
            <NativeSelectOption value='claude-3-7-sonnet'>claude-3-7-sonnet</NativeSelectOption>
            <NativeSelectOption value='claude-3-5-haiku'>claude-3-5-haiku</NativeSelectOption>
          </NativeSelectOptGroup>
        </NativeSelect>
...
export const SmallDisabled: Story = {
  render: () => (
    <NativeSelect size='sm' disabled defaultValue='locked'>
      <NativeSelectOption value='locked'>Provider locked by policy</NativeSelectOption>
    </NativeSelect>
  ),
}
