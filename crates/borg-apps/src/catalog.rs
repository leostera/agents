...
impl DefaultAppsCatalog {
    ...
    fn build_memory_app() -> DefaultApp {
        DefaultApp {
            ...
            name: "Memory System",
            slug: "memory-system",
            description: "Long-term memory app for searching and writing facts used by agents across actor runs.",
            status: "active",
            auth_strategy: "none",
            auth_config_json: json!({}),
            available_secrets: Vec::new(),
    ...
    fn build_schedule_app() -> DefaultApp {
        DefaultApp {
            ...
            description: "Durable scheduler app for creating and managing one-shot and cron jobs that deliver Borg chat messages to actors.",
            status: "active",
            auth_strategy: "none",
            auth_config_json: json!({}),
            available_secrets: Vec::new(),
