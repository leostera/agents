...
use crate::llm::completion::{
    ModelSelector, ProviderType, RawCompletionRequest, RawCompletionResponse,
};
...
mod tests {
    ...
    use crate::llm::provider::LlmProvider;
    use crate::llm::transcription::{AudioSource, AudioTranscriptionRequest, TranscriptionFormat};
