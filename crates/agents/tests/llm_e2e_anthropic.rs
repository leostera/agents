...
#[tokio::test]
async fn anthropic_provider_chat_raw_returns_text_long() -> LlmResult<()> {
...
#[tokio::test]
async fn anthropic_runner_typed_response_round_trip_long() -> LlmResult<()> {
    let model = anthropic_model();
...
#[tokio::test]
async fn anthropic_runner_decodes_typed_tool_calls_long() -> LlmResult<()> {
    let model = anthropic_model();
    let runner = runner_with_anthropic_model(&model)?;
...
#[tokio::test]
async fn anthropic_runner_streams_typed_response_long() -> LlmResult<()> {
    let model = anthropic_model();
    let runner = runner_with_anthropic_model(&model)?;
...
#[tokio::test]
async fn anthropic_runner_streams_typed_tool_calls_long() -> LlmResult<()> {
    let model = anthropic_model();
    let runner = runner_with_anthropic_model(&model)?;
