...
//!
//! 1. define a suite with [`#[suite]`](evals_macros::suite)
//! 2. define one or more evals with [`#[eval]`](evals_macros::eval)
...
//! use evals::{eval, suite, trajectory, user};
//! use evals::{EvalContext, Trajectory};
//! use anyhow::Result;
//!
...
pub use evals_macros::{eval, grade, suite};
pub use events::{
...
/// ```rust
/// use agents::agent::SessionAgent;
/// use evals::{Trajectory, trajectory, user};
///
/// type BasicAgent = SessionAgent<String, (), (), String>;
///
...
/// use evals::{GradeResult, Trajectory, predicate};
///
/// type BasicAgent = SessionAgent<String, (), (), String>;
///
...
mod tests {
    ...
    use agents::llm::provider::LlmProvider;
    use agents::llm::transcription::{AudioTranscriptionRequest, AudioTranscriptionResponse};
