...
pub struct PortAdminResult {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub ports: Option<Vec<borg_db::PortRecord>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub port: Option<borg_db::PortRecord>,
}
