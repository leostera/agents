...
pub struct UpdateTaskFieldsArgs {
    pub actor_id: String,
    pub uri: String,
    pub patch: TaskPatchArgs,
}

#[derive(Debug, Clone, Deserialize, Serialize)]
pub struct ActorUriUriArgs {
    pub actor_id: String,
    pub uri: String,
}
...
#[derive(Debug, Clone, Deserialize, Serialize)]
pub struct ActorUriUriLabelsArgs {
    pub actor_id: String,
    pub uri: String,
    #[serde(default)]
...
#[derive(Debug, Clone, Deserialize, Serialize)]
pub struct ActorUriUriBlockedByArgs {
    pub actor_id: String,
    pub uri: String,
...
#[derive(Debug, Clone, Deserialize, Serialize)]
pub struct ActorUriUriDuplicateOfArgs {
    pub actor_id: String,
    pub uri: String,
...
#[derive(Debug, Clone, Deserialize, Serialize)]
pub struct ActorUriUriReferenceArgs {
    pub actor_id: String,
    pub uri: String,
...
pub struct SplitTaskIntoSubtasksArgs {
    ...
    pub creator_actor_id: String,
    pub uri: String,
    pub subtasks: Vec<SplitSubtaskArgs>,
}

#[derive(Debug, Clone, Deserialize, Serialize)]
pub struct SplitSubtaskArgs {
    pub title: String,
    #[serde(default)]
    pub description: Option<String>,
    #[serde(default)]
...
pub enum TaskGraphCall {
    #[serde(rename = "TaskGraph-createTask")]
    CreateTask(CreateTaskArgs),
    #[serde(rename = "TaskGraph-getTask")]
    GetTask(GetTaskArgs),
    #[serde(rename = "TaskGraph-listTasks")]
    ListTasks(ListTasksArgs),
    #[serde(rename = "TaskGraph-updateTaskFields")]
    UpdateTaskFields(UpdateTaskFieldsArgs),
    #[serde(rename = "TaskGraph-reassignAssignee")]
    ReassignAssignee(ReassignAssigneeArgs),
    #[serde(rename = "TaskGraph-addTaskLabels")]
    AddTaskLabels(ActorUriUriLabelsArgs),
    #[serde(rename = "TaskGraph-removeTaskLabels")]
    RemoveTaskLabels(ActorUriUriLabelsArgs),
    #[serde(rename = "TaskGraph-setTaskParent")]
    SetTaskParent(SetTaskParentArgs),
    #[serde(rename = "TaskGraph-clearTaskParent")]
    ClearTaskParent(ActorUriUriArgs),
    #[serde(rename = "TaskGraph-listTaskChildren")]
    ListTaskChildren(UriListArgs),
    #[serde(rename = "TaskGraph-addTaskBlockedBy")]
    AddTaskBlockedBy(ActorUriUriBlockedByArgs),
    #[serde(rename = "TaskGraph-removeTaskBlockedBy")]
    RemoveTaskBlockedBy(ActorUriUriBlockedByArgs),
    #[serde(rename = "TaskGraph-setTaskDuplicateOf")]
    SetTaskDuplicateOf(ActorUriUriDuplicateOfArgs),
    #[serde(rename = "TaskGraph-clearTaskDuplicateOf")]
    ClearTaskDuplicateOf(ActorUriUriArgs),
    #[serde(rename = "TaskGraph-listDuplicatedBy")]
    ListDuplicatedBy(UriListArgs),
    #[serde(rename = "TaskGraph-addTaskReference")]
    AddTaskReference(ActorUriUriReferenceArgs),
    #[serde(rename = "TaskGraph-removeTaskReference")]
    RemoveTaskReference(ActorUriUriReferenceArgs),
    #[serde(rename = "TaskGraph-setTaskStatus")]
    SetTaskStatus(SetTaskStatusArgs),
    #[serde(rename = "TaskGraph-submitReview")]
    SubmitReview(ActorUriUriArgs),
    #[serde(rename = "TaskGraph-approveReview")]
    ApproveReview(ActorUriUriArgs),
    #[serde(rename = "TaskGraph-requestReviewChanges")]
    RequestReviewChanges(RequestReviewChangesArgs),
    #[serde(rename = "TaskGraph-splitTaskIntoSubtasks")]
    SplitTaskIntoSubtasks(SplitTaskIntoSubtasksArgs),
    #[serde(rename = "TaskGraph-addComment")]
    AddComment(AddCommentArgs),
    #[serde(rename = "TaskGraph-listComments")]
    ListComments(TaskUriListArgs),
    #[serde(rename = "TaskGraph-listEvents")]
    ListEvents(TaskUriListArgs),
    #[serde(rename = "TaskGraph-nextTask")]
    NextTask(ActorUriLimitArgs),
    #[serde(rename = "TaskGraph-reconcileInProgress")]
    ReconcileInProgress(ActorUriLimitArgs),
}

#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum TaskGraphResult {
    TaskGraph(TaskGraphToolResult),
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TaskGraphToolResult {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub task: Option<crate::model::TaskRecord>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tasks: Option<Vec<crate::model::TaskRecord>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub children: Option<Vec<crate::model::TaskRecord>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub created: Option<Vec<crate::model::TaskRecord>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub parent: Option<crate::model::TaskRecord>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub child: Option<crate::model::TaskRecord>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub comment: Option<crate::model::TaskCommentRecord>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub comments: Option<Vec<crate::model::TaskCommentRecord>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub events: Option<Vec<crate::model::TaskEventRecord>>,
    #[serde(skip_serializing_if = "Option::is_none")]
            ...
            move |request: borg_agent::ToolRequest<CreateTaskArgs>| {
                ...
                async move {
                    ...
                    let task = store
                        ...
                        .await?;
                    json_text(serde_json::to_value(TaskGraphResult {
                        task: Some(task),
                        ..Default::default()
                    })?)
                }
